...
const PostCard = ({ id }) => {
  ...
  const updateVotes = async (action) => {
    ...
    if (author && data.isLoggedIn) {
      switch (action) {
        case "upvote": {
          axios
            .put(`http://localhost:4000/api/post/${currentPost._id}/upvote`, { author })
        ...
        case "downvote": {
          axios
            .put(`http://localhost:4000/api/post/${currentPost._id}/downvote`, { author })
            .then((res) => setCurrentPost(res.data))
            .catch((err) => console.log(err));
          break;
        }
        case "deletePost": {
          axios
            .delete(`http://localhost:4000/api/post/${currentPost._id}/deletePost`, { author })
            .then((res) => setCurrentPost(res.data))
            .catch((err) => console.log(err));
          break;
        }
  ...
  const submitComment = async (e) => {
    if (e.keyCode === 13) {
      console.log(data);
      await axios
        .put(`http://localhost:4000/api/post/update/comment`, { author: data.signed_user._id, postId: id, content: commentData })
        .then((res) => setCurrentPost(res.data))
        .catch((err) => console.log(err));
      setCommentData("");
    }
          ...
          <div className="flex flex-col justify-between py-2 w-full">
            <div className=" mb-2">
              <div className="flex space-x-2 items-center mb-2">
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                {data.signed_user._id === currentPost.author._id || data.signed_user.userType === "admin" ? <DeleteIcon onClick={() => deletePost(currentPost._id, currentPost.title)} /> : null}
              </div>
